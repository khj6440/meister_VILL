        ...
        <div class="main_hcontainer">
            <div class="user_container">
                ...
                <div class="p_user_infbox">
                        <div class="p_user_nickname">닉네임</div>
                        ...
                        <div class="p_user_project">
                        	<div class="p_user_project_1"> 개</div>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item mx-0 mx-lg-1 p-border"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="#portfolio">소개</a></li>
                        <li class="nav-item mx-0 mx-lg-1 p-border"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="#about">서비스</a></li>
                        <li class="nav-item mx-0 mx-lg-1 p-border"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="#contact">평점</a></li>
                    </ul>
                </div>
            </div>
        </nav>
