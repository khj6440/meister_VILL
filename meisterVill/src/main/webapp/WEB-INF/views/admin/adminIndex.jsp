...
<script type="text/javascript" src="https://code.jquery.com/jquery-3.3.1.js"></script>
  <!-- Favicons -->
  <link href="resources/adminCss/img/favicon.png" rel="icon">
  <link href="resources/adminCss/img/apple-touch-icon.png" rel="apple-touch-icon">

  <!-- Bootstrap core CSS -->
  <link href="resources/adminCss/lib/bootstrap/css/bootstrap.min.css" rel="stylesheet">
  <!--external css-->
  <link href="resources/adminCss/lib/font-awesome/css/font-awesome.css" rel="stylesheet" />
  <link rel="stylesheet" type="text/css" href="resources/adminCss/css/zabuto_calendar.css">
  <link rel="stylesheet" type="text/css" href="resources/adminCss/lib/gritter/css/jquery.gritter.css" />
    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          <p class="centered"><a href="profile.html"><img src="resources/adminCss/img/ui-sam.jpg" class="img-circle" width="80"></a></p>
