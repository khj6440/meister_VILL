...
<html>
    <head>
        ...
        <link rel="stylesheet" href="/resources/hj/test/css/bootstrap-theme.min.css">
        ...
        <script src="/resources/hj/test/js/vendor/modernizr-2.8.3-respond-1.4.2.min.js"></script>
    </head>
...
<body>
    ...
    <div class="sequence">
      ...
      <div class="seq-preloader">
        ...
        <nav>
          <div class="logo">
              <img src="/resources/hj/test/img/logo.png" alt="">
          </div>
          <div class="mini-logo">
          ...
          <div class="slide" id="1">
            <div class="content first-content">
              <!-- <div class="container-fluid">
                  <div class="col-md-3">
                      <div class="author-image"><img src="/resources/hj/test/img/author_image.png" alt=""></div>
                  </div>
                  <div class="col-md-9">
                      <h2>Mingalar par</h2>
              ...
              <iframe src="/meister/project/home.do?projectNo=1" style="width: 100%;height: 100%;" frameborder="0"></iframe>
            </div>
          </div>
          <div class="slide" id="2">
            <div class="content second-content">
                <!-- <div class="container-fluid"> -->
                    ...
                    <iframe src="/meister/project/chat.do?projectNo=1" style="width: 100%;height: 100%;" frameborder="0"></iframe>
                <!-- </div> -->
            </div>
          </div>
          <div class="slide" id="3">
            <div class="content third-content">
                <!-- <div class="container-fluid"> -->
                    ...
                    <iframe src="/meister/project/files.do?projectNo=1" style="width: 100%;height: 100%;" frameborder="0"></iframe>
                <!-- </div> -->
            </div>
          </div>
